...
-- OpenComputers + Speech Box (speech_box)
-- Minecraft 1.12.2
--------------------------------------------------
...
local function initializeComponents()
  ...
  if component.isAvailable("speech_box") then
    ...
    centerText(4, "SPEECH SYSTEM ONLINE")
    speech.say("speech system online")
  else
    centerText(4, "SPEECH SYSTEM NOT FOUND")
  end
  ...
  centerText(6, "REDSTONE INTERFACES: " .. tostring(#redstones))
  os.sleep(2)
end
...
local function authenticate()
  clearScreen(0x000000, 0xFFFFFF)
  centerText(5, "SELF DESTRUCT CONTROL SYSTEM")
  centerText(7, "ENTER AUTHORIZATION CODE")
  centerText(9, "> ")
